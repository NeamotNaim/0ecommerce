...
{{-- <div class="container">
    <div class="row justify-content-center">
        ...
        <div class="wrapper without_header_sidebar">
            <!-- contnet wrapper -->
            <div class="content_wrapper" style="width: 500px;margin:0 auto;">
                <!-- page content -->
                <div class="registration_page center_container">
                    <div class="center_content">
                        ...
                        <form action="{{route('register')}}" method="post">
                            ...
                            <div class="form-group icon_parent">
                                <span class="icon_soon_bottom_right"><i class="fas fa-phone"></i></span>
                            ...
                            <div class="form-group text-center">
                                ...
                                <button type="submit" class="btn btn-blue bg-primary mx-auto ">Signup</button>
                            </div>
                        </form>
