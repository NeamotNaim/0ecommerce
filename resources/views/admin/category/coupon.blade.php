            ...
            <table id="datatable1" class="table display responsive nowrap">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td> {{$row->coupon}}</td>
                  <td> {{$row->discount}}%  </td>
                  <td><a href="{{URL::to('coupon/edit/'.$row->id)}}"   class="btn btn-info mr-1" >Edit</a>
                    <a href=" {{URL::to('coupon/delete/'.$row->id)}} " class="btn btn-danger"  id="delete">Delete</a></td>
              ...
              <form method="POST" action=" {{route('coupon.store')}} ">
                @csrf
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="" placeholder="Enter coupon code" name="coupon">
                        
                      </div>
                        <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Coupon Discount(%)</label>
                        <input type="text" class="form-control" id="" placeholder="Enter coupon discount" name="discount">
