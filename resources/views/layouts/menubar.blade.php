						...
						<div class="main_nav_content d-flex flex-row">
							...
							<div class="cat_menu_container">
								...
								<ul class="cat_menu">
									...
									<li class="hassubs">
										<a href=" {{url('products/category/'.$row->id)}} ">{{$row->category_name}} <i class="fas fa-chevron-right"></i></a>
										<ul>
											@php
											...
											<li class="hassubs">
												<a href=" {{url('products/subcategory/'.$row->id)}} ">{{$row->subcategory_name}}<i class="fas fa-chevron-right"></i></a>
								...
								<ul class="standard_dropdown main_nav_dropdown">
									...
									<li class="hassubs">
										...
										<ul>
												...
												<li><a href="{{url('products/brand/'.$item->id)}}">{{$item->brand_name}}<i class="fas fa-chevron-down"></i></a></li>	
												@endforeach
										</ul>
									</li>
									<li class="hassubs">
										...
										<ul>
											<li><a href=" {{asset('/')}} ">Shop<i class="fas fa-chevron-down"></i></a></li>
											<li><a href="{{asset('/')}}">Product<i class="fas fa-chevron-down"></i></a></li>
											...
											<li><a href="{{route('blog.post')}}">Regular Post<i class="fas fa-chevron-down"></i></a></li>
											<li><a href="{{url('cart/view')}}">Cart<i class="fas fa-chevron-down"></i></a></li>
					...
					<div class="col">
						...
						<div class="page_menu_content">
							...
							<ul class="page_menu_nav">
								...
								<li class="page_menu_item"><a href="{{asset('frontend/blog.html')}}">blog<i class="fa fa-angle-down"></i></a></li>
