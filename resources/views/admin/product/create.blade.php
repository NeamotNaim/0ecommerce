    ...
    <div class="sl-mainpanel">
      <nav class="breadcrumb sl-breadcrumb">
       ...
       <div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title">Create Product Page
            <a href="{{route('product.all')}} "  class="btn btn-sm btn-success pull-right">All Product</a>
          </h6>
          
          <p class="mg-b-20 mg-sm-b-30">Create product form </p>
            ...
            <div class="row mg-b-25">
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="product_quantity"  placeholder="Enter quentity">
                </div>
              </div><!-- col-4 -->
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="product_size" value="" placeholder="Enter size" id="productsize" data-role="tagsinput">
                </div>
              </div><!-- col-4 -->
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="product_color" value="" placeholder="Enter Color" id="productcolor" data-role="tagsinput">
                </div>
              </div>
               ...
               <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="selling_prize" value="" placeholder="Enter selling prize"  >
                </div>
              </div><!-- col-4 -->
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="discount_prize" value="" placeholder="Enter selling prize"  >
                </div>
              </div><!-- col-4 -->
               ...
               <div class="col-lg-12">
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="summernote" name="product_details"  placeholder="Enter details" ></textarea>
              ...
              <div class="col-lg-12">
                <div class="form-group">
                  ...
                  <input class="form-control" id="" name="vedio_link" value="" placeholder="video link " >
                </div>
              </div><!-- col-4 -->
